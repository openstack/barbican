...
# Typically an authenticated user session will make a request for a key to barbican
...
#curl -XPOST -d '{"auth":{"passwordCredentials":{"username": "demo", "password": "secret"}, \
# "tenantName": "demo"}}' -H "Content-type: application/json" http://localhost:35357/v2.0/tokens 
#
